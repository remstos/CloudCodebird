CloudCodebird for Parse.com
==============

Codebird.js module for Parse CloudCode


This is a module for [Parse Cloud Code](https://parse.com/docs/cloud_code_guide) based on [Codebird.js](https://github.com/jublonet/codebird-js) (2.5.0), a javascript framework to make [Twitter](https://dev.twitter.com/docs/api) API (1.1) call. 


Support for Oauth, App only Oauth, Twitter REST Api...

Installation
------------

- Put `CloudCodebird.js` in your `cloud.` folder.
- In `main.js`, add the following lines:

```javascript
var Codebird = require('cloud/CloudCodebird');
var cb = new Codebird();
```
...
App Only Oauth example
```javascript
// App Only Oauth example :
Parse.Cloud.define("tw_oauth", function(request, response) {
...
```javascript
// Search_Tweets example :
Parse.Cloud.define("tw_search", function(request, response) {
