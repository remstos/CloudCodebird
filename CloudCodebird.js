...
console.log('__call function');
    ...
    var oauth2_token = function (callback) {
       ...
       var authorization = "Basic " + _base64_encode(_oauth_consumer_key + ":" + _oauth_consumer_secret);
	...
	var _callApi = function (httpmethod, method, method_template, params, multipart, app_only_auth, internal, callback) {
        ...
        if(httpmethod == 'GET') {
            ...
            Parse.Cloud.httpRequest({
                    ...
                    error: function(httpResponse) {
                        console.error('GET Request failed with response code ' + httpResponse.status);
                        callback(httpResponse);
                    }
                });
